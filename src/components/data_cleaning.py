...
class DataCleaningConfig:
    ...
    Attributes:
        ...
        raw_ingested_path : Path to where the csv file will be stored
    """
    ...
    #After this processing stage:stored to raw_ingested_data
    cleaned_ingested_dir:Path = None
    ...
    def __post_init__(self) -> None:
        ...
        self.cleaned_ingested_dir = self.data_dir / "cleaned_ingested_data"
        #self.cleaned_ingested_csv = self.cleaned_ingested_dir / ""
...
class DataCleaning:
    ...
    def declare_dtypes_early(self,enhanced_data_with_no_nulls:pd.DataFrame)->pd.DataFrame:  #Not a pure function but falls in "standardization"
        ...
        try:
            ...
            logging.info(f"{enhanced_data_with_no_nulls.columns}")
            logging.info("======================================================")
    ...
    # === SAVING THE OUTPUT === #
    def save_ouput(self, enhanced_data_with_no_nulls:pd.DataFrame):
        """
        Saving the result to our cleaned_ingested_data dir
        :params -> enhanced_data_with_no_nulls
        :rtypes -> no return types
        """
        ...
        try:
            ...
            raise CustomException(e,sys) from e
        print("Step 4: Output successfully stored")
        logging.info("Data Cleaning: Step 4: Saving the cleaned file....SUCCESSFULLY SAVED...")
        logging.info("=====================================================")
...
if __name__ == "__main__":
    ...
    obj.save_ouput(standardized_no_nulls)
